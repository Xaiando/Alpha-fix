...
def test_file(file_path):
    ...
    try:
        ...
        print(f"  Center alpha: {mid_alpha:.3f}")
...
test_file(r"C:\Users\Kaged\Movies\Hub\Projects\image-remix\emoji_angry.mp4")
test_file(r"C:\Users\Kaged\Movies\Hub\Projects\image-remix\emoji_applause.mp4")
test_file(r"C:\Users\Kaged\Movies\Hub\Projects\image-remix\emoji_wink.mp4")
